    ...
    if (loading) {
        ...
        return (
            <div>
                ...
                <div className="card mt-4 mb-3 mx-auto" style={{ maxWidth: "540px" }}>
                    <div style={{fontSize:"18px", fontWeight:"600"}} className="card-header">
                        Bill Details
                    </div>
                    <div className="card-body">
                        <p style={{fontSize:"18px", fontWeight:"600"}} className="card-text">Hotel Name : {hotelData.name}</p>
                        <p style={{fontSize:"18px", fontWeight:"600"}} className="card-text">Location : {hotelData.location}</p>
                        <h2 className="card-text">Items</h2>
                        {cartData && cartData.map(ele => {
                            return (
                                <p style={{fontSize:"18px", fontWeight:"600"}} className="card-text">{ele.food_name} : {ele.quantity} * {ele.rate} = {(ele.quantity) * (ele.rate)}</p>
                            )
                        })}
                ...
                <div  className={Styler_css.coupon_btn} >
                    <Button  style={{fontSize:"18px", fontWeight:"600"}} color="success" onClick={toggle}>Apply Coupon</Button>
                </div>
